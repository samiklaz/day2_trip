              ...
              child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        FadeAnimation(Text(page.toString(), style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold))),
                        FadeAnimation(Text('/' + totalPage.toString(), style: TextStyle(color: Colors.white, fontSize: 15,))),
                      ],
                    ),
                    Expanded(
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            FadeAnimation(Text(title, style: TextStyle(color: Colors.white, fontSize: 50, fontWeight: FontWeight.bold))),
